...
val normalImage = Application.createImage("images/Yuumi.png", "tray icon")
val loadingImage = Application.createImage("images/loading.gif", "tray icon")
...
object Application {
    ...
    internal fun createImage(path: String, description: String?): Image? {
        val imageURL = Application::class.java.getResource(path)
